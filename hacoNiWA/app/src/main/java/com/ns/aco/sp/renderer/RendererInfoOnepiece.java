...
public class RendererInfoOnepiece extends RendererInfoBase {

	// コンストラクタ
	public RendererInfoOnepiece(GL11 gl11, ServiceContract.Service service) {
	...
	protected final VboInfo _vboInfoHairWalkR = new VboInfo(
		"00_Yucco/Hair/MediumPerm/V_HairMediumPermWalkR.txt",
		"00_Yucco/Hair/MediumPerm/VN_HairMediumPermWalkR.txt",
		"00_Yucco/Hair/MediumPerm/VT_HairMediumPermWalkR.txt"
	);
	protected final VboInfo _vboInfoDressWalkR = new VboInfo(
		"00_Yucco/Dress/Onepiece/V_DressOnepieceWalkR.txt",
		"00_Yucco/Dress/Onepiece/VN_DressOnepieceWalkR.txt",
		"00_Yucco/Dress/Onepiece/VT_DressOnepieceWalkR.txt"
	);
	...
	protected final VboInfo _vboInfoHairMotionLess = new VboInfo(
		"00_Yucco/Hair/MediumPerm/V_HairMediumPermMotionLess.txt",
		"00_Yucco/Hair/MediumPerm/VN_HairMediumPermMotionLess.txt",
		"00_Yucco/Hair/MediumPerm/VT_HairMediumPermMotionLess.txt"
	);
	protected final VboInfo _vboInfoDressMotionLess = new VboInfo(
		"00_Yucco/Dress/Onepiece/V_DressOnepieceMotionLess.txt",
		"00_Yucco/Dress/Onepiece/VN_DressOnepieceMotionLess.txt",
		"00_Yucco/Dress/Onepiece/VT_DressOnepieceMotionLess.txt"
	);
	...
	protected final VboInfo _vboInfoHairWalkL = new VboInfo(
		"00_Yucco/Hair/MediumPerm/V_HairMediumPermWalkL.txt",
		"00_Yucco/Hair/MediumPerm/VN_HairMediumPermWalkL.txt",
		"00_Yucco/Hair/MediumPerm/VT_HairMediumPermWalkL.txt"
	);
	protected final VboInfo _vboInfoDressWalkL = new VboInfo(
		"00_Yucco/Dress/Onepiece/V_DressOnepieceWalkL.txt",
		"00_Yucco/Dress/Onepiece/VN_DressOnepieceWalkL.txt",
		"00_Yucco/Dress/Onepiece/VT_DressOnepieceWalkL.txt"
	);
	...
	protected void loadRendererModel(){
		...
		if (_service.get_charaNo() == R.drawable.gate_onepiece1_top){
			...
			_bodyTexture = _draw3DObject.loadTexture(R.drawable.bodylayout_heel1, _service.get_windowWidth(), _service.get_windowHeight());
			_hairTexture = _draw3DObject.loadTexture(R.drawable.hair_mediumperm1, _service.get_windowWidth(), _service.get_windowHeight());
			_dressTexture = _draw3DObject.loadTexture(R.drawable.dress_onepiece1, _service.get_windowWidth(), _service.get_windowHeight());
			_shoeTexture = _draw3DObject.loadTexture(R.drawable.shoe_heel1, _service.get_windowWidth(), _service.get_windowHeight());
		}else{
			_faceTexture = _draw3DObject.loadTexture(R.drawable.face_yucco1, _service.get_windowWidth(), _service.get_windowHeight());
			_faceTexture_close = _draw3DObject.loadTexture(R.drawable.face_yucco1_close, _service.get_windowWidth(), _service.get_windowHeight());
			_faceTexture_swagger = _draw3DObject.loadTexture(R.drawable.face_yucco1_swagger, _service.get_windowWidth(), _service.get_windowHeight());
			...
			_faceTexture_wink = _draw3DObject.loadTexture(R.drawable.face_yucco1_wink, _service.get_windowWidth(), _service.get_windowHeight());
			_bodyTexture = _draw3DObject.loadTexture(R.drawable.bodylayout_heel1, _service.get_windowWidth(), _service.get_windowHeight());
			_hairTexture = _draw3DObject.loadTexture(R.drawable.hair_mediumperm2, _service.get_windowWidth(), _service.get_windowHeight());
			_dressTexture = _draw3DObject.loadTexture(R.drawable.dress_onepiece2, _service.get_windowWidth(), _service.get_windowHeight());
