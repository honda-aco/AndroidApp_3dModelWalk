...
public class RendererInfoFrog extends RendererInfoBase {

	// コンストラクタ
	public RendererInfoFrog(GL11 gl11, ServiceContract.Service service) {
	...
	protected void loadRendererModel(){
		...
		if (_service.get_charaNo() == R.drawable.gate_frog1_top){
