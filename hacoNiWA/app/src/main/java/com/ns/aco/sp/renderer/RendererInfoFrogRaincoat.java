...
public class RendererInfoFrogRaincoat extends RendererInfoBase {

	// コンストラクタ
	public RendererInfoFrogRaincoat(GL11 gl11, ServiceContract.Service service) {
	...
	protected final VboInfo _vboInfoBodyWalkR = new VboInfo(
		"02_Frog/Body/V_BodyWalkR.txt",
		"02_Frog/Body/VN_BodyWalkR.txt",
		"02_Frog/Body/VT_BodyWalkR.txt"
	);
	protected final VboInfo _vboInfoDressWalkR = new VboInfo(
		"02_Frog/Dress/Raincoat/V_DressRaincoatWalkR.txt",
		"02_Frog/Dress/Raincoat/VN_DressRaincoatWalkR.txt",
		"02_Frog/Dress/Raincoat/VT_DressRaincoatWalkR.txt"
	);
	//立ちポーズ
	protected final VboInfo _vboInfoBodyMotionLess = new VboInfo(
		"02_Frog/Body/V_BodyMotionLess.txt",
		"02_Frog/Body/VN_BodyMotionLess.txt",
		"02_Frog/Body/VT_BodyMotionLess.txt"
	);
	protected final VboInfo _vboInfoDressMotionLess = new VboInfo(
		"02_Frog/Dress/Raincoat/V_DressRaincoatMotionLess.txt",
		"02_Frog/Dress/Raincoat/VN_DressRaincoatMotionLess.txt",
		"02_Frog/Dress/Raincoat/VT_DressRaincoatMotionLess.txt"
	);
	//歩く（左足上げ）ポーズ
	protected final VboInfo _vboInfoBodyWalkL = new VboInfo(
		"02_Frog/Body/V_BodyWalkL.txt",
		"02_Frog/Body/VN_BodyWalkL.txt",
		"02_Frog/Body/VT_BodyWalkL.txt"
	);
	protected final VboInfo _vboInfoDressWalkL = new VboInfo(
		"02_Frog/Dress/Raincoat/V_DressRaincoatWalkL.txt",
		"02_Frog/Dress/Raincoat/VN_DressRaincoatWalkL.txt",
		"02_Frog/Dress/Raincoat/VT_DressRaincoatWalkL.txt"
	);
	...
	protected void loadRendererModel(){
		...
		if (_service.get_charaNo() == R.drawable.gate_frograin1_top){
			_bodyTexture = _draw3DObject.loadTexture(R.drawable.bodylayout_frog1, _service.get_windowWidth(), _service.get_windowHeight());
			_dressTexture = _draw3DObject.loadTexture(R.drawable.dress_raincoat1, _service.get_windowWidth(), _service.get_windowHeight());
		}else{
			_bodyTexture = _draw3DObject.loadTexture(R.drawable.bodylayout_frog2, _service.get_windowWidth(), _service.get_windowHeight());
			_dressTexture = _draw3DObject.loadTexture(R.drawable.dress_raincoat2, _service.get_windowWidth(), _service.get_windowHeight());
		}
	}
	...
	public void setLight() {
		...
		float[] position0 = { 0.0f, 0.5f, 3.0f, 0.0f };
		float[] position1 = {-1.5f, -3.0f, 0.0f, 1.0f };
		float[] position2 = { 1.5f, -3.0f, 0.0f, 1.0f };
		float[] position3 = {-2.5f, 3.0f, 1.0f, 1.0f };
		float[] position4 = { 2.5f, 3.0f, 1.0f, 1.0f };
		...
		_gl11.glEnable(GL11.GL_LIGHT3);		// ライト３を使用する
	    _gl11.glLightfv(GL11.GL_LIGHT3, GL11.GL_POSITION, position3, 0);
	    _gl11.glLightfv(GL11.GL_LIGHT3, GL11.GL_DIFFUSE, diffuse, 0);

		_gl11.glEnable(GL11.GL_LIGHT4);		// ライト４を使用する
	    _gl11.glLightfv(GL11.GL_LIGHT4, GL11.GL_POSITION, position4, 0);
	    _gl11.glLightfv(GL11.GL_LIGHT4, GL11.GL_DIFFUSE, diffuse, 0);
	}
