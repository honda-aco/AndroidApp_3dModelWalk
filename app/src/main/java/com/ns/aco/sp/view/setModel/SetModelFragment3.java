...
public class SetModelFragment3 extends SetModelFragment{
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.fragment_setmodel_tabitem3, container, false);

        _linearLayout = (LinearLayout) root.findViewById(R.id.linearRight);
    ...
    protected String getDirectoryPath(){
        return getString(R.string.convert_directory).replaceFirst("\\?", "0").replaceFirst("\\?", getString(R.string.value0018));
    }

    @Override
    protected String getSaveFinishedMessage(){
        return getString(R.string.value0033).replaceFirst("\\?", getString(R.string.value0018));
    }
}
